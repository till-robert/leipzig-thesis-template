...
\usepackage[pdfusetitle, unicode, linkbordercolor=leipzigDarkRed, citebordercolor=leipzigDarkRed]{hyperref}
\usepackage{bookmark}
...
\title{\LaTeX document class for theses at Leipzig University}
\date{1970}
\birthplace{Berlin}
\chair{Computational Quantum Field Theory (CQT)}
\division{Institut für Theoretische Physik}
\thesisclass{Master of Science}
\submissiondate{September 30, 2024}
\firstcorrector{Prof.~Dr.~Erstgutachter}
\secondcorrector{Prof.~Dr.~Zweitgutachter}

% tu logo on top of the titlepage
\titlehead{\includegraphics[height=2.5cm]{logos/logo.pdf}}
